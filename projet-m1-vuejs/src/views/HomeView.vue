  ...
  <div id="home">
    ...
    <div class="search-area">
      <form @submit.prevent="getData">
        <input style="background:none;border: none;border-bottom: 1px solid white;margin-right: 5px;width: 30%;color:white;" type="search" placeholder="Rechercher une bière" v-model="query">
